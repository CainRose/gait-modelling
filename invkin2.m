function q_traj = invkin2(dh, x3_traj, z3_traj, psi3_traj, q0)
% Function: q_traj = invkin2(dh, x3_traj, z3_traj, psi3_traj, q0)
% 
...
%*************************************************************************
    ...
    for i = 2:steps
        ...
        t1 = acos((l1^2 + dist0_2^2 - l2^2)/(2*l1*dist0_2));
        t2 = acos((l1^2 + l2^2 - dist0_2^2)/(2*l1*l2));
        t3 = pi - t1 - t2;

function [ansp] = invkin_traj_gen_modb(DH_mat, obj_ite_stride_time, design_var)
AEP_L3_J1 = design_var(4);  AEP_L3_J2 = design_var(5);  AEP_L3_J3 = design_var(6);
take_off_angle_toe = design_var(12);
attack_angle_toe = design_var(13);
take_off_angle_hip = design_var(14);
attack_angle_hip = design_var(15);
...
DH_temp = DH_mat;
DH_temp(1:3, 4) = [AEP_L3_J1; AEP_L3_J2;AEP_L3_J3];
...
[theta_sw, dtheta_sw, ddtheta_sw] = Bezier_trajectory(0, 0, take_off_angle_toe, 0, -attack_angle_toe, 0, obj_ite_step_length, t_steps_swing);
swing_l = theta_sw(1,:);
swing_y = theta_sw(2,:);
% %keyboard();
if beta1 > 0.5
...
q0 = [AEP_L3_J1; AEP_L3_J2; AEP_L3_J3]; % Initial guess for invkin function
...
ansp(:,t_steps_swing+1) = [AEP_L3_J1; AEP_L3_J2; AEP_L3_J3];

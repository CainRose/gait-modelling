function [ansp] = invkin_traj_gen_modfr(DH_mat, obj_ite_stride_time, design_var, stride_length)

beta1 = design_var(1);
AEP_L2_J1 = design_var(2);  AEP_L2_J2 = design_var(3);  AEP_L2_J3 = design_var(4);
...
DH_temp = DH_mat;
DH_temp(1:3, 4) = [AEP_L2_J1; AEP_L2_J2;AEP_L2_J3];
...
% keyboard();
q0 = [AEP_L2_J1; AEP_L2_J2; AEP_L2_J3]; % Initial guess for invkin function

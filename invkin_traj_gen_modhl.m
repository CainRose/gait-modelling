function [ansp] = invkin_traj_gen_modhl(DH_mat, obj_ite_stride_time, design_var, stride_length)

beta1 = design_var(1);
AEP_L3_J1 = design_var(2);  AEP_L3_J2 = design_var(3);  AEP_L3_J3 = design_var(4);

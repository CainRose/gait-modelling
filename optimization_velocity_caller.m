...
options.numVar = 97;                     % number of design variables
...
options.objfun = @objective_function_velocity;     % objective function handle
...
options.initfun = {@initpop, 'initial_population2.txt'};
result = nsga2(options, 25);                % begin the optimization!
% % % % 

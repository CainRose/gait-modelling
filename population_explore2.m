function population_explore2(file, velocity)
clc
%--------------------------------------------------------------------------
% load('results.mat');
data_robot = loadpopfile(file);
%--------------------------------------------------------------------------
%--------------------------------------------------------------------------
numObj = 1;
...
title(['Evolution of Objective at ' num2str(velocity) ' m/s']);
xlabel('Generation');
ylabel('Power Loss');
grid on;
hold off
saveas(h3, ['Evolution of Power Loss at ' num2str(velocity) ' (Scatter Plot).png']);
...
title(['Evolution of Objective at ' num2str(velocity) ' m/s'], 'FontSize', 15);
...
grid on;
hold off
saveas(h1_e, ['Evolution of Power Loss at ' num2str(velocity) '.png']);
end
